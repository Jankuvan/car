        ...
        <div class="row mb-5">
          <div class="col-md-9 order-2">
            ...
            if(isset($_GET['limite'])){
                $resultado = $conexion ->query("select * from productos where inventario > 0 limit ".htmlentities(addslashes(base64_decode(($_GET['limite'])))).",".$limite)or die($conexion -> error);
            }else{
                ...
                <div class="site-block-27">
                  <ul>
                    ...
                    for($k=0;$k<$totalBotones;$k++){
                      echo '<li><a href="index.php?limite='.base64_encode(($k*10)).'">'.($k+1).'</a></li>';
                    }
                    ?>
...
const popoverList = [...popoverTriggerList].map(popoverTriggerEl => new bootstrap.Popover(popoverTriggerEl))
    ...
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-6848616814216662"
